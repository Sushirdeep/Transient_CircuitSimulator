 function [ new_M, new_I, new_row]= stamp_cap_FE(old_M, old_I, D, t_step, Node_vlt, i_cap)

%STAMP_CAP_FE : stamps entries corresponding to a Capacitor during Forward
...
new_I(length_M+1)= volt_cap_diff + ((t_step/cap_value)* i_cap) ;
new_row = length_M+1;
