 function [ new_M, new_I, new_row]= stamp_cap_BE(old_M, old_I, D, t_step, Node_vlt)

%STAMP_CAP_BE : stamps entries corresponding to a Capacitor during Backward
%Euler Transient Analysis
%
%
%        syntax: [new_M, new_I, new_row]= stamp_cap_BE(old_M, old_I, D, t_step, Node_vlt)
%
...
if n1>0, new_M(length_M+1, n1) = cap_value/t_step ; new_M(n1, length_M+1)= 1; end;
if n2>0, new_M(length_M+1, n2) = -cap_value/t_step ; new_M(n2, length_M+1)= -1; end;
...
new_I(length_M+1)= (cap_value/t_step)* volt_cap_diff ;
new_row = length_M+1;
